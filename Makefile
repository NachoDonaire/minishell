SRCS = get_env.c main.c ft_check_commands.c utils.c ft_check_builtins.c builtins/ft_pwd/ft_pwd.c builtins/ft_cd/ft_cd.c builtins/ft_echo/ft_echo.c builtins/ft_unset/ft_unset.c builtins/ft_export/ft_export.c \
