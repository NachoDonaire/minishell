SRCS	=	src/main.c src/utils/utils.c src/utils/utils2.c src/free/memory.c src/status/ft_status.c src/env/ft_get_env.c \
			...
			src/builtins/ft_echo/ft_echo2.c src/builtins/ft_echo/ft_echo3.c  src/builtins/ft_export/ft_export2.c src/builtins/ft_export/ft_export.c src/builtins/ft_echo/ft_echo4.c \
			...
			src/gnl/get_next_line_utils.c src/gnl/get_next_line.c src/lexer/redirects/fd_reds2.c src/lexer/builtins/check_builtins2.c \
			src/lexer/redirects/d_red.c  src/lexer/redirects/d_red2.c 
